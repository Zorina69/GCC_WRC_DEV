...
export default function AllTempUrls() {
  ...
  useEffect(() => {
    fetch(`${import.meta.env.VITE_API_URL}/gccft2026/`)
      .then((res) => {
  ...
  const getFullUrl = (tempId) => {
    return `${window.location.origin}/gccft/gccft2026/${tempId}`;
  };
    ...
    <>
      ...
      <div className="container">
        <div className="header">
          <h1>🌍 All Temp URLs — GCC FIELD TRIP 2026</h1>
          <p>កម្មវិធីទស្សនកិច្ចសិក្សាស្រាវជ្រាវ​ ប្រចាំឆ្នាំ២០២៦ ({participants.length} នាក់)</p>
        </div>
