...
export default function Gccft2026() {
  return (
    <div className="cs-root">
      ...
      <div className="cs-content">
        ...
        <h1 className="cs-title-kh">កម្មវិធីទស្សនកិច្ចសិក្សាស្រាវជ្រាវ​ ប្រចាំឆ្នាំ២០២៦</h1>
        <p className="cs-title-en">GCC FIELD TRIP 2026</p>
