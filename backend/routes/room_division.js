...
// Local data folder (works cross-platform; /tmp doesn't exist on Windows)
...
function checkEligibility(roomId, person, rooms, forceOverride = false) {
  ...
  // Room 14: Male Mixed - allows both Male Students and Male Teachers
  // Room 15: Male Teacher (Single) - only Male Teachers
  // Room 16: Male Teachers (2 pax) - only Male Teachers
...
// API Routes (mounted under /api/room-division in server.js, so these become
// /api/room-division/api/rooms, /api/room-division/api/people, etc.)
